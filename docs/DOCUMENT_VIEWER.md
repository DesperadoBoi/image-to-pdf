...
- XLSX visual fidelity includes direct/indexed/theme cell fills, basic font attributes, borders,
  ...
  focal-point pinch 60–300%, явные Fit width и Fit sheet до 25% и double tap между Fit width и
  100%. Геометрия листа хранится независимо от экрана; prefix sums и binary search выбирают
